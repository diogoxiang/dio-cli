...
function init(args) {
        ...
        vfs.src(['**/*', '!mode_modules/**/*'], { cwd: tpl, cwdbase: true, dot: true })
            ...
            .on('end', function() {
                try {
                    ...
                    console.log();
                    require('./install')(mirror, done) // install package
                } catch (e) {
                    console.log(error(e))
                }
            })
    ...
    function done() {
        ...
        > ${chalk.bold.white('npm run dist')}        Compile your project`);

        console.log();
        console.log(`${chalk.bold.cyan('Dio!')} https://github.com/diogoxiang/dio-cli`)
    }
